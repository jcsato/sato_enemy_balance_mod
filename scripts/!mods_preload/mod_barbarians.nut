::mods_queue("sato_enemy_balance", "", function() {
	::Const.Tactical.Actor.BarbarianMarauder.FatigueRecoveryRate = 15;		// Default is 20
	::Const.Tactical.Actor.BarbarianMarauder.Bravery = 60;					// Default is 80
	::Const.Tactical.Actor.BarbarianChampion.FatigueRecoveryRate = 15;		// Default is 20
	::Const.Tactical.Actor.BarbarianChampion.Bravery = 75;					// Default is 90
	::Const.World.Spawn.Troops.BarbarianChampion.Cost = 50;					// Default is 35
